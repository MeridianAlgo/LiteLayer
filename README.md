...
**Beta channel** — in the Software Update dialog you can switch the update channel from **Stable** (`main`) to **Beta** (`testing` branch) to try new and experimental features early. Switch back to Stable any time; the next update returns you to `main`.
